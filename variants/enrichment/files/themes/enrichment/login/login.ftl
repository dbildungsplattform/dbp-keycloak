    ...
    <#elseif section = "form">
        <div id="kc-form" class="flex flex-col justify-center items-center h-full px-4 md:px-0">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="${properties.kcInputGroup!}">
                                <label class="form-control w-full max-w-xs relative">
                                    ...
                                    <span class="absolute right-0 bottom-0.5 select-none">
                                        <span class="cursor-pointer"
                                              ...
                                              aria-controls="password" data-password-toggle tabindex="0"
                                ...
                                <div class="flex justify-end mt-1">
                                    <a tabindex="0" href="${url.loginResetCredentialsUrl}" class="link link-sm">
                                        Passwort vergessen?
                                    </a>
                                </div>
                            </div>
            ...
            <div class="text-center mt-2">
                <a href="${client.baseUrl}" tabindex="0" class="link cursor-pointer">zurück zur Startseite</a>
            </div>
        </div>
